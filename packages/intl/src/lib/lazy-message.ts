import type { IntlMessageOptions, Translator } from './translator.ts'

export type LazyMessage =
  | {
      type: 'gettext'
      message: string
      options?: IntlMessageOptions
    }
  | {
      type: 'pgettext'
      context: string
...
export function gettextLazy(message: string, options?: IntlMessageOptions): LazyMessage {
